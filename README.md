...
Now, we need configure environment variables to store the weather API key secure, and set the name of the S3 bucket. Here we are adding environment variable to the .env file, this practice separates environment variables configurations from the main code.
